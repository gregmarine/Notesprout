...
- `extensions/sketch` — **NSE · Sketch**, the raster-sketch extension for Notesprout SN (the tenth
  ...
  the Nomad; **`ink` merged to `main` 2026-09-18 (`--no-ff`) and deleted**)
...
- `ink` — arc 45 "Ink" COMPLETE + FROZEN 2026-09-18 on the user's Nomad hand walks; **merged to
  ...
  there is history (plan + ledger — read for *why*, never resumed). **No ELEVENTH extension point
  and no new arc without a user decision.**
