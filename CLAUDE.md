...
- `extensions/sketch` — **NSE · Sketch**, the raster-sketch extension for Notesprout SN (the tenth
  ...
  FROZEN 2026-09-16, merge to `main` pending the user's final Nomad walk): a per-page raster pencil
  ...
  `docs/sketch.md`; read the SN `CLAUDE.md` before any work there
...
- `sketch` — **IN PROGRESS**, arc 43 "Sketch" COMPLETE + FROZEN 2026-09-16, merge to `main`
  pending the user's final Nomad walk. It carries `extensions/sketch` (**NSE · Sketch**), SN's
