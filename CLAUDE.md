...
- `extensions/bible` — **NSE · Bible**, the Bible-reader extension for Notesprout SN (the ninth SN
  ...
  its own `BIBLE_PLAN.md` + `REFERENCE_PLAN.md` + `LOOKUP_PLAN.md` + `docs/bible.md`; read the SN
  `CLAUDE.md` before any work there
