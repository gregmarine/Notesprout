...
- `extensions/sketch` — **NSE · Sketch**, the raster-sketch extension for Notesprout SN (the tenth
  ...
  one 4 px pencil lead, the shade panel on each pen button's re-tap with Atelier's swatches in a
  ...
  0.1.50, incl. a 2.5 s pause settle — withdrawn 2026-09-21 along with every tool / shade / rub / undo / chrome-open settle — a mark settles only on a one-finger swipe down or a page load, g-paper Phase 37 → 0.1.52; Phase 38 the same day — the flank's grain as the point's in grey, per-fleck paleness — built, walked and **withdrawn**, deferred in `BACKLOG.md`; its own `PALETTE_PLAN.md`)
