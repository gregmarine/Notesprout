...
| **NSE · Bible** — the Bible reader for Notesprout SN (arc 37, 2026-09-13): the slim Berean Standard Bible SQLite build, the paginated print-look reader (paragraphs, poetry indents, section headings, superscript verse numbers), single-finger swipe with chapter/book flow, the Book ↔ Chapter index, the stored last-read position, the `extensions/` monorepo-root module pattern | [`extensions/bible/docs/bible.md`](extensions/bible/docs/bible.md) |
