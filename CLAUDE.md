...
- `extensions/bible` — **NSE · Bible**, the Bible-reader extension for Notesprout SN (the ninth SN
  ...
  Song-of-Solomon target bug fixed)): lives at the monorepo root and is included
  ...
  `CROSSREF_PLAN.md` + `docs/bible.md`; read the SN `CLAUDE.md` before any work there
