...
- `extensions/sketch` — **NSE · Sketch**, the raster-sketch extension for Notesprout SN (the tenth
  ...
  0.1.49; its own `PALETTE_PLAN.md`)
...
- `tools` — **ACTIVE** (2026-09-19): arc 46 "Palette" — Atelier's sixteen tones for the sketch
  ...
  the same way (0.1.45–0.1.49, branch `ink-true`, on top of it; both unmerged), `API_VERSION` 20 → 21 as a parcel tail. Expected to carry further tool arcs
