...
- **N5 — docs + freeze.** DONE 2026-09-14. `extensions/bible/docs/bible.md` § "Notes — the
  ...
  is now dated now rather than 0). **The user's Nomad hand walk PASSED 2026-09-15 ("All tests pass") — arc 42 COMPLETE + FROZEN.** Branch `crossref` **merged to `main` 2026-09-15 (`--no-ff`) and deleted** — "on crossref" means `main`.
