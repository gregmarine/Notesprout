...
### G3 — Outcome (2026-09-18) — the face ✅
...
reopen, the finger double-tap chrome toggle, PDF export and the cover, feel — *"Clean!"*

**Next.** G4 skipped (nothing found). G5 — docs + freeze: `docs/sketch.md` (two rasters, the
