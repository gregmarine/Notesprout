...
- **Plans:** `PAPER_PLAN.md` (v0, complete — architecture + locked decisions), then
  ...
  `PAPER_CONTENTS_PLAN.md` (arc 5, **in progress — C0 🧪 (built 2026-08-18, awaiting user device
  check) · C1 ⬜ · C2 ⬜**: the
  ...
  active arc is 5 — next: flip C0 to ✅ on the user's word, then C1's phase ritual (wizard questions
  in the plan)**
