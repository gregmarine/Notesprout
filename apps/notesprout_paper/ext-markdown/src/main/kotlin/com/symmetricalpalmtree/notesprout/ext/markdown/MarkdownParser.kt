...
// Verbatim port of the original Notesprout `core/markdown/MarkdownParser.kt` (arc 4 / H0). Pure
// Kotlin — no Android types — so it is JVM-tested. Blocks: heading 1–6, paragraph, list item
// (ordered / unordered / task, depth by two-space indent), blockquote, horizontal rule; inlines: text,
// bold, italic, strikethrough, code, link (display text only), image (alt text as italic).
