...
/**
 * The pad's top bar (arc 6 / S1) over the shared [PaperToolbar] (Back · Pen · Eraser · Lasso), plus
 * the **Send** button — present only when the pad was opened from a notebook ([sendEnabled],
...
class ScratchToolbar(
    ...
    private val base = PaperToolbar(binding.topBar, binding.btnBack, binding.btnPen, binding.btnEraser, binding.btnLasso, paper, onBack)
