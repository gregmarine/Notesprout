 ...
 * launch. The minted string doubles as the user's **recovery key**: the one secret that unlocks the
 * library after a reinstall or on another device. Dashes and prefix are part of the string.
 * Never logged.
 */
object GlobalKey {
