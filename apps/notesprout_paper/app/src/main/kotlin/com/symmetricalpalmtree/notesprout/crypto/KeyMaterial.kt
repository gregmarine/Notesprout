 ...
 *
 * Resolution: process RAM → [DerivedKeyStore] (Keystore) → derive + persist. v0 has only the GLOBAL
 * scope, so every key is persisted. Blocking on a miss (KDF) — call on Dispatchers.IO/Default.
 */
object KeyMaterial {
