...
`0.1.0-ratta`; **2087 JVM tests/variant**. **Arc 25 "Drive" (the EIGHTH point, `ACTION_CLOUD_STORAGE`, granted 2026-09-04; V1–V6 complete + frozen 2026-09-05 — `:ext-drive`, THIRTEEN modules, `API_VERSION` 8, 2340 JVM tests/variant, reference `docs/cloud.md`) lives in its OWN file — `DRIVE_PLAN.md`; read that, not this, for arc-25 work.**
