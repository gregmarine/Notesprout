 ...
 * ciphertext as a corrupt database, and the default handler would then wipe the user's notebook
 * and leave an empty file behind. The original Notesprout lost a notebook exactly this way.
 *
 ...
 * delegated unchanged. **Every Room open in SN goes through this wrapper** — see
 * [com.symmetricalpalmtree.notesproutsn.crypto.SoilCrypto].
 */
    ...
    override fun create(configuration: SupportSQLiteOpenHelper.Configuration): SupportSQLiteOpenHelper {
        ...
        val safeCallback = object : SupportSQLiteOpenHelper.Callback(inner.version) {
            ...
            override fun onCorruption(db: SupportSQLiteDatabase) {
                // DO NOT delete. A wrong-key open of an encrypted file surfaces here; deleting
                // would destroy the user's data. Fail loudly and leave the file untouched.
