 ...
 * (`docs/soil-file-format.md` Part V): float32 + zlib, lossless. Byte-compatible with Paper's
 * codec — proven by fixture tests against blobs Paper's implementation produced.
 *
 ...
 * g-paper dependency; the notebook layer maps to/from g-paper `StrokePoint`s.
 */
object StrokeCodec {
