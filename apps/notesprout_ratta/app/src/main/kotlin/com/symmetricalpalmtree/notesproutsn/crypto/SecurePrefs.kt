 ...
 *
 * [PassphraseStore] + [AttemptLimiter] share one file; [DerivedKeyStore] has its own. Everything
 * goes through here because androidx.security keyset creation is not safe across concurrent
 * first-creations of the same file, and the Keystore can throw transiently right after boot
 * (one retry absorbs that).
 */
