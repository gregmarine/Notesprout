...
android {
    namespace = "com.symmetricalpalmtree.notesproutsn.ext.scratchpad"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.symmetricalpalmtree.notesproutsn.ext.scratchpad"
        minSdk = 29
        targetSdk = 35
        versionCode = 1
...
dependencies {
    // The extension owns a paper-hosting SCREEN (arc 11): the contract + the shared screen library
    // (g-paper arrives through its `api`). Never :app; no Room / SQLCipher / serialization — its data
