...
- **P2 — pad + calendar + event note — COMPLETE 2026-09-22 on the user's Nomad hand walk ("All tests pass")** (built the same day on the
...
- **P3 — the sticky editor — COMPLETE 2026-09-22 on the user's Nomad hand walk ("Tests pass")** (built on the user's
...
- **P5 — freeze — 2026-09-22.** Arc 49 "Panel" is **COMPLETE + FROZEN**: every writing face on
  ...
  `panel-ink` (Phases 42–44, 0.1.56 → 0.1.59) **merged to g-paper `main` 2026-09-22 (`--no-ff`, 10d35b4) and deleted, local + remote, on the user's word — g-paper has only `main`**; SN `tools` merged to `main` 2026-09-24 and deleted. Recorded: this ledger; `docs/sn-screen.md`
